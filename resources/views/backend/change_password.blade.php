                    ...
                    <div class="card-body">
                        <form action="{{url('chnage/my/password')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" value="{{Auth::user()->email}}" placeholder="Email" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group text-center pt-2">
                                <input type="submit" value="Change Passowrd" class="btn btn-success rounded">
                            </div>
                        </form>
                    </div>
                </div>
