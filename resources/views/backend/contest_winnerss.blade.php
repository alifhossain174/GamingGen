                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label>Select Contest</label>
                                          <form action="{{url('/contest/winner/page')}}" method="POST">
                                             @csrf
                                        <select class="form-control" id="contest_id" name="contest_id" required onchange="this.form.submit()">
        ...
        foreach($contest_subscribers as $contest_subscribersdata){
               foreach($users as $usersdata){
                   ...
                   if($usersdata->id == $contest_subscribersdata->user_id){
                     ...
                     <td style='width: 20%'><input type='text' name='kill[]' placeholder='No. of Kills' style='width: 90%' value=''></td><br>";  
